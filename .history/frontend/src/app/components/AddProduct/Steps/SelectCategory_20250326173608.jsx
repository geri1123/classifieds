...
export default function SelectCategory({ formData, changeHandler  , setFormData}) {
    ...
    return (
        (
            <div className="select-category flex flex-col w-full min-h-screen pt-4 pl-4">
                <h2 className="text-2xl font-semibold">Please select a listing type and category for your listing.</h2>

    ...
    return (
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                      {/* Add Subcategory under subcategory parent Form  for example will add benz under car//....*/}
                <div className="bg-gray-100 p-4 rounded-lg shadow">
                    <h2 className="text-lg font-semibold mb-2">Add Subcategory under subcategory parent</h2>
                    ...
                    >
                        ...
                        {categories.map((subcategories) => (
                            <option key={subcategories.id} value={category.id}>
                                {category.name}
                            </option>
                        ))}
                    </select>

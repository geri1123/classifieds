...
export default async function ProductsPage(props) {
  ...
  try {
    ...
    // Get the auth token specifically - assuming it's named 'authToken'
    // Adjust the cookie name based on what your app actually uses
    ...
    const response = await fetch(
      ...
      {
        headers: {
          // Pass the token as a proper Authorization header

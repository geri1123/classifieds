...
router.get("/products/complete", async (req, res) => {
  try {
    ...
    // Create maps for images and attributes by product_id
    ...
    const completeProducts = products.map(product => {
      ...
      // Format attributes as object with name as key for easier access

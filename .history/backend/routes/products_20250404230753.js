...
router.get("/all-products", async (req, res) => {
  ...
  try {
    // First query: Get the total count of products
    let countQuery = `
      SELECT 
        COUNT(*) AS total 
      FROM 
    ...
    productsQuery += ` GROUP BY p.id ORDER BY p.created_at DESC LIMIT ? OFFSET ?`;
    ...
    // Third query: Get all products with their attributes in a flattened structure

  ...
  try {
    ...
    let query = `
      SELECT 
        ...
        GROUP_CONCAT(DISTINCT CONCAT(a.name, ':', pa.value) SEPARATOR ', ') AS attributes, 
    ...
    const processedResults = results.map((product) => {
      ...
      // Format the attributes to be more readable
      return {
        ...product,
        images,
        // Keep the original attributes string for parsing in the frontend
      };
    });

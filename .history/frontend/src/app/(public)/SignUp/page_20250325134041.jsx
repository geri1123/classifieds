...
//   }
  ...
  return (
    <div className="flex  flex-col items-center mt-6 justify-center">
      ...
      {isOpen && (
        <div
          className={`fixed top-0 left-0 w-full  pt-[70px] pb-[70px] overflow-y-auto h-full bg-gray-600 bg-opacity-70 flex justify-center items-center z-50 transition-all duration-500 ease-in-out ${isClosing ? 'animate-fadeOut' : 'animate-fadeIn'}`}
        >
          <div
            ref={dropdownRef}

...
const [selectedSubcategoryForItem, setSelectedSubcategoryForItem] = useState("");
    ...
    async function addSubcategoryItem() {
        ...
        try {
            ...
            const newItem = { id: response.data.subcategoryItemId, name: newSubcategoryItem, subcategory_id: selectedSubcategoryForItem };
            setSubcategoryItems([...subcategoryItems, newItem]); // Update UI
        ...
        <div className="p-6 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div className="bg-gray-100 p-4 rounded-lg shadow">
                  ...
                  {/* {selectedParentSubcategory &&  <input
                        type="text"
                        className="border p-2 w-full rounded mt-2"

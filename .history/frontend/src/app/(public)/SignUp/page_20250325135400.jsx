...
//   }
  ...
  return (
    <div className="flex  flex-col items-center mt-6 justify-center">
      ...
      {isOpen && (
        <div
        className={`fixed z-50 top-0 left-0 w-full h-screen bg-gray-950 bg-opacity-70 flex justify-center items-center transition-all duration-500 overflow ${isClosing ? 'animate-fadeOut' : 'animate-fadeIn'}`}
        >
          <div
            ref={dropdownRef}

            ...
            <div key={product.id} className="border-2 border-yellow-40 bg-white p-4 rounded-lg flex flex-col relative">
              ...
              <div className="relative">
                ...
                {openDropdownId === product.id && (
                  <div
                    ref={dropdownRef}
                    className="absolute bg-gray-100 border-black-300 shadow-lg border-1 transform transition-all duration-100 ease-in-out animate-fadeInOut bottom-8 right-0 dark:bg-white shadow-light w-32 z-10"
                  >

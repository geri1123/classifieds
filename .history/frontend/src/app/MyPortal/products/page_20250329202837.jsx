...
async function fetchProducts(category) {
  try {
    const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_URL}/api/products?category=${category}`, {
      method: 'GET',
      cache: 'no-store',
      credentials: 'include', // Ensures cookies are sent if authentication is needed
    });
...
export default async function ProductsPage({ searchParams }) {
  ...
  return <ProductsByCategory products={data.products} />;
}
...
// Memoize the ProductsComponent to prevent unnecessary re-renders
const MemoizedProductsComponent = memo(ProductsComponent);

export default function ProductsPage() {
  return <MemoizedProductsComponent fetchProductsAction={fetchProductsAction} />;
}
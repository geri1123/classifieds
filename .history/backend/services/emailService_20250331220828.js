...
const sendPropertyStatusEmail = (email, status, propertyId, title) => { 
  ...
  const sendRegisteredEmail=(email)=>{
    subject = 'Regjistrimi u krye me sukses';
    htmlContent = `
      <html>
        <head>
          <style>
        ...
        <body>
          <h1>Regjistrimi u krye me sukses</h1>


          <p>Thank you for using our portal. For more details, visit our website.</p> <a href="http://localhost:3000/myportal/profile" class="button">View Portal</a>
        </body>
      </html>`

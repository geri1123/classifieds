    ...
    return (
        <div className="first-inputs flex flex-col gap-2">
            ...
            <div className="max-w-100 flex flex-col gap-2">
                <label className="block text-gray-700 dark:text-gray-200" htmlFor="description">Description <span className="text-red-500">*</span></label>
               <div className="max-w-100">
                <textarea className="w-full" name="description" onChange={changeHandler} placeholder="Product or Job description" value={formData.description} className="form-control" id="description">

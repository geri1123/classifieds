  ...
  return (
    <div className="flex flex-col gap-3 items-center">
      ...
      <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-full group">
        ...
        <div className="absolute right-2 md:hidden bottom-2 p-1 bg-gray-800 rounded-full">
        ...
        <div 
          className="absolute inset-0 bg-gray-600 bg-opacity-50 rounded-full flex items-center justify-center
                     opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          onClick={handleUploadClick}
        >
          <button className="w-full h-full rounded-full flex flex-col items-center justify-center">
            <FiUpload size={40} className="text-gray-100" /> 

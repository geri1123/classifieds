    ...
    return (
        <div className="first-inputs flex flex-col gap-2">
            ...
            <div className="max-w-100 flex flex-col ">
                ...
                <textarea name="description" onChange={changeHandler} placeholder="Product or Job description" value={formData.description} className={`form-control ${errors.description?"border-red-500"}`} id="description">

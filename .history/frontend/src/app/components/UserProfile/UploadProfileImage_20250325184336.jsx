  ...
  return (
    <div className="flex flex-col gap-3 items-center">
      ...
      <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-full group">
        {/* Profile Image */}
        <img className="w-full h-full object-cover rounded-full border-4 border-blue-500" src={user?.profile_img? user?.profile_img :"/images/nprf.jpg" } alt="profile" />

        {/* Small Plus Icon (Always Visible) */}
        <div className="absolute right-2 bottom-2 p-1 bg-gray-200 rounded-full">

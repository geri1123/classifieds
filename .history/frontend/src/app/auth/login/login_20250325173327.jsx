          ...
          <div className="mb-4">
            ...
            <div className="flex items-center border rounded-lg border-gray-300 pl-3 py-1">
              ...
              <input
                ...
                onChange={onChange}
                className="w-full dark:text-black pl-2 border-none focus:outline-none focus:outline-none"
              />
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center border rounded-lg border-gray-300 pl-3 py-1">
              ...
              <input
                ...
                onChange={onChange}
                className="w-full dark:text-black pl-2 border-none focus:outline-none"
              />
            </div>

...
export function Other(){
    return(
        <div className="flex justify-end flex-col gap-2 md:gap-3 w-full">
            <button className="md:text-sm text-xs md:w-[170px] flex items-center gap-1 font-semibold border dark:text-gray-200 text-gray-800 rounded-lg p-2 md:p-2 dark:border-gray-200 border-yellow-900">

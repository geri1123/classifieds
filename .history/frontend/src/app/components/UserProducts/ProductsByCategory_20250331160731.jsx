...
export default function ProductsByCategory({ products: initialProducts, category ,fetchProducts }) {
  ...
  const handleStatusUpdated = (productId, newStatus) => {
    // Update the product in the state without a page reload
  ...
  return (
    <div>
      <h1 className="md:text-3xl flex gap-3 text-2xl my-6 font-semibold dark:text-white text-gray-900">

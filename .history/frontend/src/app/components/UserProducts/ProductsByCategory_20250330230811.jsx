  ...
  >
    {product.status_type.toUpperCase()}
              ...
              <div className='relative w-full flex items-center gap-2 justify-end'>
               {product.status_type === "published" ? <button className='border-2 px-2 py-1 rounded hover:bg-yellow-40 border-yellow-40'>
                Deactivate
                </button> : <button className='border-2 px-2 py-1 hover:bg-yellow-40 border-yellow-40 rounded'>
                  Publish
                </button>}

    ...
    <div className="social-media flex flex-col gap-4">
      ...
      {/* Display social media data */}
        ...
        <ul className="grid grid-cols-2 gap-2">
          ...
          {user?.linkedin &&  <a href="" className="flex gap-2"></a><li className="flex gap-2"><FaLinkedin size={23} color="#0A66C2" /> {user.linkedin}</li>}
          {user?.fiver && <li  className="flex gap-2"><TbBrandFiverr size={23} color="#1DBF73" /> {user.fiver}</li>}
        </ul>

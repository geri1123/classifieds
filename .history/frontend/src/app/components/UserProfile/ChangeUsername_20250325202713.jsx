  ...
  return (
    <div>
      <div className="flex items-center ">
       ...
       <h2 className=" dark:text-gray-100 text-gray-700 flex items-center gap-1">@ <span className="border-b border-b-gray-900 dark:border-b-gray-100">{user?.username}</span></h2>

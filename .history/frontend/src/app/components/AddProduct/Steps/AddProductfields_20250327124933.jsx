export default function AddPProductFields ({ changeHandler, formData, categories, subcategories}){
       ...
       const selectedSubcategoryItem = subcategories.find(sub => String(sub.id) === String(formData.subcategory_item_id));
    return (
        <>
         <h2>
                ...
                {selectedSubcategoryItem ? selectedSubcategoryItem.name : "No Subcategory Item Selected"}
            </h2>

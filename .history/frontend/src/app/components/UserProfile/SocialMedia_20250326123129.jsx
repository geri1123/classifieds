    ...
    <div className="social-media flex flex-col gap-4">
      ...
      {/* Display social media data */}
        ...
        <ul className="grid grid-cols-2 gap-2">
          {user?.instagram && <li > <a href="" className="flex gap-2">  <FaInstagram size={23} color="#E4405F" />  {user.instagram}</a> </li>}
          {user?.facebook && <li  > <a href="" className="flex gap-2"><FaFacebook size={23} color="#1877F2" /> {user.facebook}</a></li>}
          {user?.linkedin &&  <li className="flex gap-2"><a href="" className="flex gap-2"><FaLinkedin size={23} color="#0A66C2" /> {user.linkedin}</a></li>}
          {user?.fiver && <li  className="flex gap-2"><a href="" className="flex gap-2"><TbBrandFiverr size={23} color="#1DBF73" /> {user.fiver}</a></li>}
        </ul>

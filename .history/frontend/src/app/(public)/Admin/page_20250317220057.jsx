...
export default function ManageAttributes() {
    ...
    async function fetchAttributes(subcategoryId) {
        const res = await axios.get(`/api/attributes/${subcategoryId}`);
    ...
    async function addSubcategory() {
        await axios.post('/api/subcategory', { name: newSubcategory, category_id: selectedCategory });
        setNewSubcategory('');
        fetchSubcategories(selectedCategory);
    }

    async function addAttribute() {
        await axios.post('/api/attribute', { name: newAttribute, subcategory_id: selectedSubcategory });
        setNewAttribute('');

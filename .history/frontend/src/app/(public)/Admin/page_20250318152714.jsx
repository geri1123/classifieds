...
export default function ManageAttributes() {
    ...
    function filterSubcategories() {
        return subcategories.filter(sub => 
            ...
            (selectedParentSubcategory && sub.parent_id === selectedParentSubcategory)
        );
    }
    ...
    async function addSubcategory() {
        ...
        try {
            const response = await axios.post(`${process.env.NEXT_PUBLIC_SERVER_URL}/api/subcategory`, {
                ...
                parent_id: selectedParentSubcategory || null, // Ensure correct parent subcategory is assigned
            });
                ...
                <div className="bg-gray-100 p-4 rounded-lg shadow">
                    ...
                    {selectedCategory && (
                        ...
                        >
                            ...
                            {subcategories
                                .filter(sub => sub.category_id === selectedCategory && !sub.parent_id)
                                .map(sub => (

  ...
  return (
    <div className="social-media flex flex-col gap-4">
      ...
      {/* Display social media data */}
        ...
        <ul>
          {user?.instagram && <li>Instagram: {socialMediaData.instagram}</li>}
          {user?.facebook && <li>Facebook: {socialMediaData.facebook}</li>}
          {user?.linkedin && <li>LinkedIn: {socialMediaData.linkedin}</li>}
          {user?.fiver && <li>Fiverr: {socialMediaData.fiverr}</li>}
        </ul>

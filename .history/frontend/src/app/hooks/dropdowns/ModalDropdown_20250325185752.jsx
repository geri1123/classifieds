...
const ModalDropdown = ({ isOpen, onClose, children }) => {
  ...
  return (
    <div
      className={`fixed z-50 top-0 left-0 w-full  h-screen bg-black bg-opacity-70 flex justify-center items-center transition-all duration-500 ${

...
//
  ...
  return (
    <div className="w-full h-screen  flex  mt-7 justify-center ">
      ...
      <p>If you have forgotten your password, enter your email address below and you will receive an email with a password reset link.</p>
      <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
        ...
        <Button >
        Send the link to reset your password.
        </Button>

            ...
            <div key={product.id} className="border p-4 rounded-lg flex flex-col">
              ...
              <div className="relative">
                    <HiDotsHorizontal
                      ...
                      // }}
                      className="hover:bg-blue-yellow-40 hover:text-black duration-300 ease-in-out transition-all text-[20px] border-blue-500 text-yellow-0 dark:text-blue-200 dark:hover:bg-blue-200 dark:hover:text-black cursor-pointer border-1 dark:border-blue-200 rounded w-8 h-7 flex items-center justify-center"
                    />

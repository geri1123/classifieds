    ...
    return (
        <div className="w-full flex flex-col gap-4 ">
         ...
         <h2>
            ...
            <div className="bg-gray-100 w-full p-4 rounded-xl">
                <ProductAddress   errorMessage={errorMessage} setFormData={setFormData} formData={formData} changeHandler={changeHandler}/>
            </div>
            <div className="bg-gray-100 w-full p-4 rounded-xl">
                <AddUserInfo   errorMessage={errorMessage} setFormData={setFormData} formData={formData} changeHandler={changeHandler}/>
            </div>
        </div>
    )
}
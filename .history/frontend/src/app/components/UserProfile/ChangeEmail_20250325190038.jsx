...
import Button from "@/components/ui/buttons/Button"; from "../ui/buttons/Button";
  ...
  return (
    <div>
      ...
      <div className="flex items-center">
        ...
        <ModalDropdown isOpen={isOpen} onClose={() => {setIsOpen(false) ; setErrors('') ;   setUserData({ email: user?.email });  }}>
        <h2 className="dark:text-sky-400 text-sky-800  mb-4 text-xl">Ndrysho Email</h2>

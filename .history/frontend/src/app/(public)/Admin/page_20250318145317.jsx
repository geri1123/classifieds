...
export default function ManageAttributes() {
    ...
    const [selectedParentSubcategory, setSelectedParentSubcategory] = useState(""); // Added state for parent subcategory
    ...
    async function addSubcategory() {
        ...
        try {
            const response = await axios.post(`${process.env.NEXT_PUBLIC_SERVER_URL}/api/subcategory`, {
                ...
                parent_id: selectedParentSubcategory || null, // Link to parent subcategory if present
            });

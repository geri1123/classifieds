    ...
    return (
        <div className="bg-white w-full p-6 gap-3 h-full dark:bg-gray-800 rounded-lg shadow-md flex flex-col items-center">
           <div className="flex items-center justify-between w-full"> 
            ...
            <div className="border scrollbar xl:h-40 overflow-y-auto rounded-lg p-3 dark:border-gray-200 border-gray-700 w-full break-words whitespace-normal">
                <p className="dark:text-gray-200 text-base text-gray-800">
                  {user?.about_me ? (
                    user.about_me
                  ) : (
                    <span className="text-gray-500">Nuk ka informacion</span>
                  ) }
                </p>
            </div>

...
export default async function ProductsPage({ searchParams }) {
  ...
  if (!siteUrl) {
    console.error("Error: NEXT_PUBLIC_SITE_URL is not defined in the environment variables.");
    return <div>Error: Missing server configuration.</div>;
  }

  const apiUrl = `${siteUrl}/api/proxy?category=${status}`;

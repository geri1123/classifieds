...
async function fetchProducts(page = 1, limit = 10) {
    try {
      ...
      return data; // Return full response (products + pagination info)
    } catch (error) {
      console.error('Error fetching products:', error);
      return { products: [], total: 0 }; // Default values
    }
  }
  "use client"; // Make this a Client Component to use state & events

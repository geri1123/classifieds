...
// Use the props pattern for clarity with async operations
export default async function ProductsPage(props) {
  // Wait for props to resolve if they're a promise
  const resolvedProps = await Promise.resolve(props);
  
  // Safely extract the category
  const categoryValue = resolvedProps?.searchParams?.category || 'All';

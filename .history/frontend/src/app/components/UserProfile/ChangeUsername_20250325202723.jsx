  ...
  return (
    <div>
      <div className="flex items-center ">
       ...
       <h2 className=" dark:text-gray-100 text-gray-700 font-semi-bold flex items-center gap-1">@ <span className="border-b border-b-gray-900 dark:border-b-gray-100">{user?.username}</span></h2>
      ...
      <h2 className="dark:text-sky-400 text-sky-800  mb-4 text-xl">Change Username</h2>

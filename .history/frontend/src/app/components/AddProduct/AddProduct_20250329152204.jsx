    ...
    const handlesubmit = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setErrorMessage(data.errors || "Error submitting product.");
            }
        } catch (error) {
    ...
    return (
        <div className="w-full py-7 px-4 sm:px-10 lg:px-20 flex flex-col gap-3">
            ...
            {errorMessage && <p className="text-red-500">{errorMessage}</p>} {/* Show error message */}
                {step === 1 && <SelectCategory errorMessage={errorMessage} changeHandler={changeHandler} formData={formData} setFormData={setFormData} />}

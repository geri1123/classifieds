export default function ProductAddress({ setFormData, formData, changeHandler }) {
    ...
    console.log("Form Data:", formData);  // Ensure `formData.city` exists
    console.log("Cities:", albanianCities);  // Check that cities are available
    ...
    return (
        <div className="product-address flex flex-col gap-3">
            ...
            <div>
                <SelectInput
                    label="City"
                    value={formData.city || ""}  // Make sure this is an empty string if undefined

...
export default function AddPProductFields ({ changeHandler,setFormData,errors, formData,subcategoriesItem, categories, subcategories}){
    ...
    return (
        <div className="w-full flex flex-col gap-4 ">
         ...
         <h2>
            ...
            <FirstInputs  errors={errors}  formData={formData} changeHandler={changeHandler} /> 
            ...
            <div className="bg-gray-100 w-full p-4 rounded-xl">
                <ProductAddress errors={errors}  setFormData={setFormData} formData={formData} changeHandler={changeHandler}/>
            </div>
            <div className="bg-gray-100 w-full p-4 rounded-xl">
                <AddUserInfo  errors={errors} setFormData={setFormData} formData={formData} changeHandler={changeHandler}/>
            </div>
        </div>
    )
}
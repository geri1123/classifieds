...
export default function ManageAttributes() {
    ...
    async function addAttribute() {
        if (!newAttribute.trim() || !selectedSubcategory) {
            setAttributeErrorMessage("Attribute name is required and subcategory must be selected!");
            return;
        }
                    ...
                    {selectedSubcategory && (
                        <div className="mt-4">
                            ...
                            <button
                                ...
                                className="bg-yellow-500 text-white px-4 py-2 mt-2 w-full rounded hover:bg-yellow-600"
                            >
                                Add Attribute
                            </button>
                        </div>

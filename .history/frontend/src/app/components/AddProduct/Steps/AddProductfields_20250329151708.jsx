...
import ProductAddress from "@/components/AddProduct/SteperComponents/ProductAddress";
import AddUserInfo from "@/components/AddProduct/SteperComponents/AddUsserInfo";
export default function AddPProductFields ({ changeHandler,setFormData, formData,subcategoriesItem,errorMessage, categories, subcategories}){
    ...
    return (
        <div className="w-full flex flex-col gap-4 ">
         ...
         <h2>
            ...
            <FirstInputs   setErrorMessage={setErrorMessage} formData={formData} changeHandler={changeHandler} /> 
            ...
            <div className="bg-gray-100 w-full p-4 rounded-xl">
                <ProductAddress   setErrorMessage={setErrorMessage} setFormData={setFormData} formData={formData} changeHandler={changeHandler}/>
            </div>
            <div className="bg-gray-100 w-full p-4 rounded-xl">
                <AddUserInfo   setErrorMessage={setErrorMessage} setFormData={setFormData} formData={formData} changeHandler={changeHandler}/>
            </div>
        </div>
    )
}
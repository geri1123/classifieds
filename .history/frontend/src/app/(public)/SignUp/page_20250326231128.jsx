...
//   }
  ...
  return (
    <div className="flex w-full bg-gray-100 py-6  flex-col items-center  justify-center">
      ...
      {isOpen && (
        <div
        className={`fixed z-50 top-0 left-0 w-full h-screen bg-gray-950 bg-opacity-70 flex justify-center items-center transition-all duration-500  ${isClosing ? 'animate-fadeOut' : 'animate-fadeIn'}`}
        >
          <div
            ref={dropdownRef}
            className={`bg-white overfllow-y-auto rounded max-w-lg max-h-[calc(100vh-140px)] mb-[70px] shadow-lg transition-transform duration-500 ease-out ${isClosing ? 'animate-closeModal' : 'animate-openModal'}`}
          >

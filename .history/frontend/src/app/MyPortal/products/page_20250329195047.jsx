...
export default async function ProductsPage({ searchParams }) {
  const status = searchParams?.status || "All"; // Default to "All" if no status is provided

  try {
    console.log("Fetching from:", `${process.env.NEXT_PUBLIC_SERVER_URL}/api/user-products?category=${status}`);

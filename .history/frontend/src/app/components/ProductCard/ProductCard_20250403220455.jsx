...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="border rounded-lg shadow-lg p-4">
      {/* Product Image */}
      <img
        src={product.product_images && product.product_images.length > 0 ? product.product_images[0].url : "/placeholder.jpg"}
        alt={product.product_images && product.product_images.length > 0 ? product.product_images[0].alt : "Placeholder image"}
